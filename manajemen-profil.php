...
$query = "SELECT * FROM aboutme ORDER BY id DESC";
  ...
  <body>
    ...
    <div class="admin-container">
        <div class="container">
            <div class="row">
                <div class="col">
                    <h3>Manajemen <span class="text-primary"> Profil</span></h3>
                    <table class="table">
                        <thead>
                            <tr>
                                <th scope="col">No.</th>
                        ...
                        while ($data = mysqli_fetch_array($result)) : ?>
                            <tr>
                                ...
                                <td><?= $data['teks']; ?></td>
                                <td>
                                    <a href="profile-delete.php?id=<?= $data['id']; ?>" class="btn btn-danger">Hapus</a>
                                </td>
                            </tr>
                        <?php $no++; endwhile; ?>
                      </tbody>
    ...
    <script type="text/javascript">
        ...
        if (isset($_GET['delete'])) {
            ...
            if ($statusBukutamu == 'sukses') : ?>
                alert('Sukses menghapus profile');
